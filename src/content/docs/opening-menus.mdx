...
<Tabs syncKey='os'>
   ...
   * [X-Mouse Button Control](http://www.highrez.co.uk/downloads/xmousebuttoncontrol.htm) is a robust tool for customizing and remapping mouse buttons on Windows. It enables you to assign various actions or commands to different mouse buttons, enhancing your workflow.
  </TabItem>
  <TabItem label="macOS" icon="apple">
